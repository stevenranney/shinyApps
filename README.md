...
* [Playing craps](https://stevenranney.shinyapps.io/craps) - An app for fun (published 9 Sep 2014).  I spent a cold and windy Sunday afternoon coding a craps simulation in `R` in winter 2013.  Recently I decided that it'd be fun to rewrite that for publication to Shiny.
